...
public:
    ...
    void Begin(FrameworkElement* target, NsBool isControllable) override;
    ...
    void Begin(FrameworkElement* target, HandoffBehavior handoffBehavior,
        NsBool isControllable) override;
    ...
    void Begin(FrameworkElement* target, FrameworkElement* nameScope,
        HandoffBehavior handoffBehavior, NsBool isControllable) override;
    void Pause() override;
    ...
    NsBool IsPlaying() const override;
    NsBool IsPlaying(FrameworkElement* target) const override;
    NsBool IsPaused() const override;
    NsBool IsPaused(FrameworkElement* target) const override;
    //@}
