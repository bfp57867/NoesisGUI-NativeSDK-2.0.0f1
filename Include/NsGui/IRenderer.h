...
////////////////////////////////////////////////////////////////////////////////////////////////////
NS_INTERFACE IRenderer: public Core::Interface
{
    /// Initializes the renderer with the given vector graphics context
    virtual void Init(VGContext* context) = 0;
    ...
    virtual void SetRenderRegion(NsFloat32 x, NsFloat32 y, NsFloat32 width, NsFloat32 height) = 0;
    ...
    virtual NsBool UpdateRenderTree() = 0;
    ...
    virtual NsBool NeedsOffscreen() const = 0;
    ...
    NS_IMPLEMENT_INLINE_REFLECTION_(IRenderer, Core::Interface)
};
